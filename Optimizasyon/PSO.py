...
from Optimizasyon.solution import solution
import time
from sklearn.preprocessing import Binarizer
import Optimizasyon.transfer_functions_benchmark as transfer_functions_benchmark
...
def PSO(objf, lb, ub, dim, PopSize, iters, trainInput, trainOutput):
    ...
    convergence_curve3 = numpy.zeros(iters)
    ############################################
    ...
    for l in range(0, iters):
        ...
        if l % 1 == 0:
            print(['At iteration' + str(l + 1) + ' the best fitness on trainig is:' + str(
                gBestScore) + ', the best number of features: ' + str(featurecount)]);
        #
